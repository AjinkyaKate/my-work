                    ...
                    <div className="card animate-fade-up delay-300" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                            <div>
                                ...
                                <p style={{ color: 'var(--text-secondary)', margin: 0 }}>Scrum Alliance</p>
                            </div>
                        </div>
                        <div>
                            <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
                                Certified Scrum Product Owner qualification focusing on maximizing value and optimizing the product backlog.
                            </p>
                        </div>
                    </div>
